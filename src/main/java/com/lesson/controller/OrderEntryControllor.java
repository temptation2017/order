...
public class OrderEntryControllor {
    ...
    public String showMenus(Model model,
                            ...
                            @RequestParam(value = "useCookie", required = false)
                                    String useCookie, HttpServletRequest request, HttpServletResponse response) {
        logger.info("mid = " + mid);
        logger.info("cid = " + cid);
    ...
    public String saveMenu(Model model, HttpServletRequest request,
                           ...
                           @RequestParam(value = "price", required = true)
                                   float price) throws UnsupportedEncodingException {
    ...
    public String deleteMenu(Model model,
                             @PathVariable int mid, HttpServletRequest request, HttpServletResponse response) {
    ...
    public String saveCategory(Model model,
                               ...
                               @RequestParam(value = "cname", required = true)
