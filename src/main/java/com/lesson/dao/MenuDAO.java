...
public interface MenuDAO {
    ...
    @Results({@Result(column = "mid", property = "mid"), @Result(column = "cid", property = "cid"), @Result(column = "mname", property = "mname"), @Result(column = "price", property = "price")})
    ...
    @Result(javaType = int.class)
    public int updateMenuByMid(
            @Param("mid") int mid, @Param("cid") int cid, @Param("mname") String mname, @Param("price") float price);
